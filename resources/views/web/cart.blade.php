                        ...
                        <div class="card shadow">
                            <div class="card-body"
                                ...
                                <div class="row align-items-center mb-4 text-center product_data">
                                    <div class="col-md-2">
                                        @if ($item->variant)
                                        <img src="{{ asset($item->variant->images->first()->image_url) }}"
                                            class="img-fluid rounded" alt="Image" style="width: 80px; height: 80px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <button type="button" id="decr-btn"
                                                class="btn btn-outline-secondary btn-sm decrement-btn changeQuantity">-</button>
                                            <input type="text" name="quantity" id="quant-inp"
                                                class="qty-input form-control form-control-sm text-center"
                                                value="{{ $item->product_quant }}" style="width: 70px;" readonly>
                                            <button type="button" id="incr-btn"
                                                class="btn btn-outline-secondary btn-sm increment-btn changeQuantity">+</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="red"
                                            class="bi bi-trash deleteCartItem" viewBox="0 0 16 16">
                                            <path
            ...
            <div class="col-12 col-lg-4 bg-light pt-lg-6 aside-checkout pb-5 pb-lg-0 my-5 my-lg-0">
                <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
                    ...
                    <div class="card-body"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-dark hover-lift-sm hover-boxshadow w-100"
                                    onclick="window.location.href='{{ url('checkout') }}'">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
                <div class="card-body"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="{{ url('/')}}"
                                class="btn btn-dark hover-lift-sm hover-boxshadow float-end">Continue Shopping</a>
                        </div>
                    </div>
                </div>
            </div>
