                        ...
                        <div class="container">
                            <div class="">
                                <div class="card-body mt-2 p-5"
                                    style="background-color: #f8f9fa; border: 1px solid #ced4da; border-radius: 10px; box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);">
                                    <div class="row checkout-form">
                                        <div class="col-md-6">
                                            <label for="fname" style="font-size: 12px; font-weight: 700;">First
                                                Name</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="lname" style="font-size: 12px; font-weight: 700;">Last
                                                Name</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="phone" style="font-size: 12px; font-weight: 700;">Phone
                                                Number</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <label for="shipping" style="font-size: 12px; font-weight: 700;">Shipping
                                                Address</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                                id="shipping" name="shipping" class="form-control"
                                                placeholder="Enter Shipping Address" required>
                                        </div>
                                        <div class="col-md-6 mt-3">
                                            <label for="billing" style="font-size: 12px; font-weight: 700;">Billing
                                                Address</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                                id="billing" name="billing" class="form-control"
                                                placeholder="Enter Billing Address">
                                        </div>
                                        <div class="col-md-6 mt-3">
                                            <label for="city" style="font-size: 12px; font-weight: 700;">City</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                                id="city" name="city" class="form-control" placeholder="Enter City">
                                        </div>
                                        {{-- <div class="col-md-6 mt-3">
                                            <label for="state" style="font-size: 12px; font-weight: 700;">State</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                                id="state" name="state" class="form-control" placeholder="Enter State">
                                        </div> --}}
                                        <div class="col-md-6 mt-3">
                                            <label for="country"
                                                style="font-size: 12px; font-weight: 700;">Country</label>
                                            <input type="text" style="font-size: 14px; padding: 5px; font-weight: 400;"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="number"
                                                style="font-size: 14px; padding: 5px; font-weight: 400;" id="zip"
                                                name="zip" class="form-control" placeholder="Enter Zip Code">
                                        </div>
                ...
                <div class="col-12 col-lg-5 bg-light pt-lg-6 aside-checkout pb-5 pb-lg-0 my-5 my-lg-0">
                    <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
                        ...
                        <div class="card-body mt-3" style="">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Rs.{{ $item->variant->discount_price > 0 ?
                                                $item->variant->discount_price : $item->variant->price }}</td>
                                            @else
                                            <td>{{ $item->products->name }}</td>
                                            <td class="text-center">{{ $item->product_quant }}</td>
                                            <td class="text-center">Rs.{{ $item->products->discount_price > 0 ?
                                                $item->products->discount_price : $item->products->price }}</td>
                                            @endif
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-dark hover-lift-sm hover-boxshadow w-100">Place
                                        Order</button>
                                </div>
                            </div>
                        </div>
